...
const GradientButton = ({ type = "button", children, className = "", variant = "dark", ...props }) => {
  ...
  const lightVariant =
    "px-2 sm:px-4 md:px-6 py-2 sm:py-3 max-w-md h-12 sm:h-14 rounded-2xl text-[#05152C] mt-7 font-semibold text-sm sm:text-lg md:text-2xl bg-white border-2 border-[#114692] hover:border-[#4A90E2] hover:bg-slate-50 transition-all duration-300 shadow-xl hover:shadow-2xl transform hover:-translate-y-1 flex items-center justify-center mx-auto block";
