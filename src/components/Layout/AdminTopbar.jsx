...
import AdminDropdownMenu from "../ui/AdminDropdownMenu.jsx";
...
const AdminTopbar = ({ pageTitle, pageSubtitle }) => {
  return (
        ...
        <AdminDropdownMenu
          trigger={
            ...
            >
              ...
              <span className="absolute top-2 right-2.5 w-2.5 h-2.5 rounded-full bg-red-500 ring-2 ring-white dark:ring-slate-950" />
            </button>
          }
          widthClassName="w-72"
        >
